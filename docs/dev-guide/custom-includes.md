...
| `cart` | the current order. Passed to the head include on every page. The body include on the shipping address step is the one page that does not receive it |
