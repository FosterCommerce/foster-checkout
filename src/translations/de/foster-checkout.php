...
return [
	...
	'settings.features.enableSinglePageCheckoutHelp' => 'Ob der Checkout als eine Seite oder in einzelnen Schritten läuft.',
	...
	'settings.features.enableAddressVerificationHelp' => 'Zeigt die von Avalara korrigierte Versandadresse an, damit Kunden sie übernehmen oder ihre eigene behalten können. Gilt nur für die USA und Kanada. Erfordert das AvaTax-Plugin mit aktivierter Adressprüfung. Hat Vorrang vor Adressvorschlägen.',
	'settings.features.addressLookupEnabled' => 'Adressvorschläge',
	'settings.features.addressLookupEnabledHelp' => 'Zeigt beim Tippen passende Adressen unter der Versandadresse an und füllt das Formular mit der ausgewählten Adresse. Erfordert einen API-Schlüssel weiter unten. Wird ignoriert, solange die Avalara-Adressprüfung läuft.',
	'settings.features.addressLookupProvider' => 'Anbieter für Adressvorschläge',
	'settings.features.addressLookupProviderHelp' => 'Von welchem Dienst die Vorschläge kommen. Beide rechnen pro Suche ab.',
	'settings.features.addressLookupApiKey' => 'API-Schlüssel für Adressvorschläge',
	'settings.features.addressLookupApiKeyHelp' => 'Tragen Sie hier eine Umgebungsvariable ein, damit der Schlüssel nicht in der Projektkonfiguration landet.',
	'settings.features.addressLookupTest' => 'Verbindung testen',
	'settings.features.addressLookupTestHelp' => 'Sendet eine Suche an den Anbieter. Der Checkout verbirgt Fehler, prüfen Sie einen neuen Schlüssel daher hier.',
	'settings.features.addressLookupTestPassed' => 'Der Anbieter hat geantwortet.',
	'settings.features.addressLookupTestFailed' => 'Die Suche ist fehlgeschlagen: {message}',
	'settings.features.addressLookupTestOff' => 'Tragen Sie zuerst einen API-Schlüssel ein.',
