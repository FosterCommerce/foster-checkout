...
return [
	...
	'settings.features.addressLookupEnabled' => 'Suggest addresses as customers type',
	'settings.features.addressLookupEnabledHelp' => 'Show matching addresses under the shipping address field and fill the form from the one picked. Needs an API key below.',
	'settings.features.addressLookupProvider' => 'Address suggestion provider',
	'settings.features.addressLookupProviderHelp' => 'Google Places bills per abandoned lookup; Loqate bills per lookup and matches international addresses more closely.',
	...
	'settings.features.addressLookupTestHelp' => 'Runs one lookup against the provider. A checkout never shows a lookup failure, so this is where a wrong key surfaces.',
	'settings.features.addressLookupTestPassed' => 'The provider answered.',
	'settings.features.addressLookupTestFailed' => 'The provider rejected the request: {message}',
	'settings.features.addressLookupTestOff' => 'Set a provider and an API key first.',
