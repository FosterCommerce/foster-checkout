...
return [
	...
	'settings.features.addressLookupEnabledHelp' => 'Show matching addresses under the shipping address as customers type, and fill the form from the one picked. Needs an API key below.',
