...
return [
	...
	'settings.gateways.fieldsHelp' => 'The field handle is where the value is stored on the order. Changing it detaches values already saved against the old handle.',
