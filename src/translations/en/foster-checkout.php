...
return [
	...
	'settings.features.enableSinglePageCheckoutHelp' => 'Whether the checkout runs as one page or as separate steps.',
	...
	'settings.features.enableAddressVerificationHelp' => 'Show Avalara’s corrected shipping address so customers can accept it or keep theirs. Covers the United States and Canada only. Needs the AvaTax plugin with address validation turned on. Takes precedence over address suggestions.',
	'settings.features.addressLookupEnabled' => 'Address suggestions',
	'settings.features.addressLookupEnabledHelp' => 'Show matching addresses under the shipping address as customers type, and fill the form from the one picked. Needs an API key below. Ignored while Avalara address verification is running.',
	'settings.features.addressLookupProvider' => 'Address suggestion provider',
	'settings.features.addressLookupProviderHelp' => 'Which service the suggestions come from. Both bill per lookup.',
	'settings.features.addressLookupApiKey' => 'Address suggestion API key',
	'settings.features.addressLookupApiKeyHelp' => 'Set this to an environment variable so the key stays out of project config.',
	'settings.features.addressLookupTest' => 'Test the connection',
	'settings.features.addressLookupTestHelp' => 'Send one lookup to the provider. The checkout hides lookup failures, so test a new key here.',
	'settings.features.addressLookupTestPassed' => 'The provider answered.',
	'settings.features.addressLookupTestFailed' => 'The lookup failed: {message}',
	'settings.features.addressLookupTestOff' => 'Add an API key first.',
	...
	'settings.lineItemOptions.intro' => 'How line items are shown in the cart and at checkout.',
