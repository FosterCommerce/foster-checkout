...
return [
	...
	'settings.features.enableSinglePageCheckout' => 'Diseño del pago',
	'settings.features.enableSinglePageCheckoutHelp' => 'Si el checkout funciona como una sola página o por pasos.',
	...
	'settings.features.enableAddressVerificationHelp' => 'Muestra la dirección de envío corregida por Avalara para que los clientes puedan aceptarla o mantener la suya. Solo cubre Estados Unidos y Canadá. Requiere el plugin AvaTax con la validación de direcciones activada. Tiene prioridad sobre las sugerencias de direcciones.',
	'settings.features.addressLookupEnabled' => 'Sugerencias de direcciones',
	'settings.features.addressLookupEnabledHelp' => 'Muestra direcciones coincidentes bajo la dirección de envío mientras se escribe y rellena el formulario con la elegida. Requiere una clave de API abajo. Se ignora mientras la verificación de direcciones de Avalara está en marcha.',
	'settings.features.addressLookupProvider' => 'Proveedor de sugerencias de direcciones',
	'settings.features.addressLookupProviderHelp' => 'De qué servicio vienen las sugerencias. Ambos cobran por búsqueda.',
	'settings.features.addressLookupApiKey' => 'Clave de API para sugerencias de direcciones',
	'settings.features.addressLookupApiKeyHelp' => 'Indica una variable de entorno para que la clave no quede en la configuración del proyecto.',
	'settings.features.addressLookupTest' => 'Probar la conexión',
	'settings.features.addressLookupTestHelp' => 'Envía una búsqueda al proveedor. El checkout oculta los fallos, así que prueba aquí una clave nueva.',
	'settings.features.addressLookupTestPassed' => 'El proveedor respondió.',
	'settings.features.addressLookupTestFailed' => 'La búsqueda falló: {message}',
	'settings.features.addressLookupTestOff' => 'Añade primero una clave de API.',
	...
	'settings.general.customerOrderNotesFieldHandleHelp' => 'Campo en Pedidos que contiene la nota del cliente. Déjelo en blanco para ocultar el formulario.',
	...
	'settings.lineItemOptions.rulesTitle' => 'Reglas de reescritura',
