...
return [
	...
	'settings.features.enableSinglePageCheckout' => 'Format de mise en page du paiement',
	'settings.features.enableSinglePageCheckoutHelp' => 'Multipage (par défaut) répartit les étapes du paiement sur des pages distinctes. Page unique regroupe les étapes sur une seule page.',
	...
	'settings.gateways.fieldsHelp' => 'Champs qu’un client remplit lorsqu’il choisit ce moyen de paiement. Seuls les champs de la commande sont utilisables, car c’est là que les valeurs sont enregistrées.',
	...
	'settings.fields.help' => 'Champs qu’un client remplit à cet endroit. Un champ ne peut être utilisé qu’à un seul endroit, pour ne pas être demandé deux fois.',
	...
	'settings.fields.position.summaryHelp' => 'Affichés dans le récapitulatif à côté du paiement, pour les informations concernant l’ensemble de la commande.',
	...
	'settings.general.requiredAddressFields' => 'Champs d’adresse obligatoires supplémentaires',
	'settings.general.requiredAddressFieldsHelp' => 'Ces champs ne sont pas obligatoires dans Craft. Cochez ceux que vous voulez rendre obligatoires dans les formulaires d’adresse du paiement.',
	...
	'settings.general.customerOrderNotesFieldHandleHelp' => 'Handle du champ sur les commandes où la note du client est enregistrée. Laisser vide pour masquer le formulaire de note.',
	...
	'settings.lineItemOptions.valueMaxLengthHelp' => 'Nombre de caractères conservés d’une valeur d’option. Laissez vide pour afficher la valeur entière.',
